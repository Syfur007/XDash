...
//
// Compute tab (XDASH_V2_PLAN.md §6.6): the fleet-management layer. The
// Kaggle account panels, Machine Stats, and TensorBoard sections on this
// tab are kaggle.js's/app.js's own pre-existing markup and render
// functions, relocated here under one nav item — see index.html. This file
// adds the one genuinely new piece: the local device card, sourced from GET
...
async function loadRunnersOverview() {
  ...
  body.innerHTML = `
    ...
    <div class="concurrency-row" style="padding:12px 0 0;">
      <span class="concurrency-label">Concurrency slots in use (Scheduler's own ceiling — adjustable in Local scheduler below)</span>
